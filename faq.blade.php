  ...
  <section id="container">
        ...
        <div class="row mt mb">
          <div class="col-lg-12">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="dmbox">
                <div class="service-icon">
                  <a class="" href="faq.blade.php#"><i class="dm-icon fa fa-question fa-3x"></i></a>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="dmbox">
                <div class="service-icon">
                  <a class="" href="faq.blade.php#"><i class="dm-icon fa fa-envelope-o fa-3x"></i></a>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="dmbox">
                <div class="service-icon">
                  <a class="" href="faq.blade.php#"><i class="dm-icon fa fa-random fa-3x"></i></a>
                </div>
            ...
            <div class="accordion" id="accordion2">
              <div class="accordion-group">
                <div class="accordion-heading">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.blade.php#collapseOne">
              ...
              <div class="accordion-group">
                <div class="accordion-heading">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.blade.php#collapseTwo">
              ...
              <div class="accordion-group">
                <div class="accordion-heading">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.blade.php#collapseThree">
              ...
              <div class="accordion-group">
                <div class="accordion-heading">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.blade.php#collapseFour">
              ...
              <div class="accordion-group">
                <div class="accordion-heading">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.blade.php#collapseFive">
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="faq.blade.php#" class="go-top">
