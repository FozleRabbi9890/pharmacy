...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('admin')}}/{{asset('admin')}}/img/favicon.png" rel="icon">
  <link href="{{asset('admin')}}/{{asset('admin')}}/img/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Bootstrap core CSS -->
  <link href="{{asset('admin')}}/{{asset('admin')}}/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!--external css-->
  <link href="{{asset('admin')}}/lib/font-awesome/css/font-awesome.css" rel="stylesheet" />
  <link rel="{{asset('admin')}}/stylesheet" type="text/css" href="{{asset('admin')}}/css/zabuto_calendar.css">
  <link rel="{{asset('admin')}}/stylesheet" type="text/css" href="{{asset('admin')}}/lib/gritter/css/jquery.gritter.css" />
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.blade.php" class="logo"><b>PHARMACY<span></span></b></a>
      <!--logo end-->
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.blade.php#">
                  <div class="task-info">
                    <div class="desc">PHARMACY  Admin Panel</div>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.blade.php"><img src="{{asset('admin')}}/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="row mt">
              ...
              <!-- /col-md-4 -->
              <div class="col-md-4 col-sm-4 mb">{{asset('admin')}}/
                <!-- REVENUE PANEL -->
  ...
  <script class="{{asset('admin')}}/include" type="text/javascript" src="{{asset('admin')}}/lib/jquery.dcjqaccordion.2.7.js"></script>
  ...
  <script type="{{asset('admin')}}/text/javascript" src="{{asset('admin')}}/lib/gritter/js/jquery.gritter.js"></script>
  <script type="{{asset('admin')}}/text/javascript" src="{{asset('admin')}}/lib/gritter-conf.js"></script>
