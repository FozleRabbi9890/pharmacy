  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="lobby.blade.php">Lobby</a></li>
        ...
        <div class="chat-room mt">
          <aside class="mid-side">
            ...
            <div class="room-desk">
              ...
              <div class="room-box">
                <h5 class="text-primary"><a href="chat_room.blade.php">Dashboard</a></h5>
              ...
              <div class="room-box">
                <h5 class="text-primary"><a href="chat_room.blade.php">Support</a></h5>
              ...
              <div class="room-box">
                <h5 class="text-primary"><a href="chat_room.blade.php">MaxFront</a></h5>
            ...
            <div class="room-desk">
              ...
              <div class="room-box">
                <h5 class="text-primary"><a href="chat_room.blade.php">Dash Stats</a></h5>
              ...
              <div class="room-box">
                <h5 class="text-primary"><a href="chat_room.blade.php">Gold Clients</a></h5>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="lobby.blade.php#" class="go-top">
