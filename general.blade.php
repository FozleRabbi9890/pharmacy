  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="general.blade.php">General</a></li>
        ...
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="showback">
              ...
              <a id="remove-all" class="btn btn-danger  btn-sm" href="general.blade.php#">Remove all</a>
            </div>
            <!-- /showback -->
          </div>
          <!-- /col-lg-6 -->
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="general.blade.php#" class="go-top">
