  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li>
            <a class="active" href="inbox.blade.php">
          ...
          <div class="col-sm-3">
            <section class="panel">
              <div class="panel-body">
                <a href="mail_compose.blade.php" class="btn btn-compose">
                  <i class="fa fa-pencil"></i>  Compose Mail
                  </a>
                <ul class="nav nav-pills nav-stacked mail-nav">
                  <li class="active"><a href="inbox.blade.php"> <i class="fa fa-inbox"></i> Inbox  <span class="label label-theme pull-right inbox-notification">3</span></a></li>
                  ...
                  <table class="table table-inbox table-hover">
                    <tbody>
                      <tr class="unread">
                        ...
                        <td class="view-message  dont-show"><a href="mail_view.blade.php">Google Inc.</a></td>
                        <td class="view-message "><a href="mail_view.blade.php">Your new account is ready.</a></td>
                      ...
                      <tr class="unread">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.blade.php">Mark Thompson</a></td>
                        <td class="view-message"><a href="mail_view.blade.php">Last project updates</a></td>
                      ...
                      <tr class="unread">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.blade.php">Wonder Corp.</a></td>
                        <td class="view-message"><a href="mail_view.blade.php">Thanks for your registration</a></td>
                        <td class="view-message inbox-small-cells"></td>
                        <td class="view-message text-right">March 15</td>
                      </tr>
                      <tr class="">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.blade.php">Facebook</a></td>
                        <td class="view-message"><a href="mail_view.blade.php">New Friendship Request</a></td>
                        <td class="view-message inbox-small-cells"></td>
                      ...
                      <tr class="">
                        ...
                        <td class="view-message dont-show"><a href="mail_view.blade.php">Mark Webber <span class="label label-danger pull-right">urgent</span></a></td>
                        <td class="view-message"><a href="mail_view.blade.php">The server is down</a></td>
                        <td class="view-message inbox-small-cells"></td>
                      ...
                      <tr class="">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                        <td class="view-message dont-show"><a href="mail_view.blade.php">Facebook</a></td>
                        <td class="view-message"><a href="mail_view.blade.php">New message from Patrick S.</a></td>
                        <td class="view-message inbox-small-cells"><i class="fa fa-paperclip"></i></td>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="inbox.blade.php#" class="go-top">
